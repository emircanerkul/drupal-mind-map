Here's example code for the Content Entity Example module.
...
/**
 * @file
 * Contains \Drupal\content_entity_example\Plugin\Search\ContactSearch.
 */

namespace Drupal\content_entity_example\Plugin\Search;
...
### Code for `\Drupal\content_entity_example\Entity\ContentEntityExample\Contact::postSave()` method
  ...
  public function postSave(EntityStorageInterface $storage, $update = TRUE) {
    ...
    if ($update) {
      if (\Drupal::moduleHandler()->moduleExists('search')) {
        search_mark_for_reindex('content_entity_example_contact_search', $this->id());
      }
    }
  }
