Apigee Edge adds Drupal entities for each of the corresponding needed entities in the [Apigee management APIs](https://apidocs.apigee.com/api-reference/content/introduction "Apigee management APIs").
